                    ...
                    if guesses:
                        ...
                        if approximate is False:
                            best = max(
                                ...
                                key=lambda x: (
                                    x[1],
                                    len(self.already_solved_numbers[x[0]]),
                                ),
                            )[0]
                            return (
                                self.already_solved[best],
                                self.already_solved_numbers[best],
                            )
                        else:
                            sorty = sorted(
                                guesses,
                            ...
                            for item in sorty:
                                if item[1] > approximate:
                                    ...
                                    return (
                                        self.already_solved[item[0]],
                                        self.already_solved_numbers[item[0]],
                                    )
                            else:
                                best = max(
                                    guesses,
